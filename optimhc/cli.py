...
# TODO: use 'click' package to refactor the command line interface
...
def main():
    ...
    parser.add_argument(
        "--mode",
        type=str,
        choices=["pipeline", "experiment"],
        default="pipeline",
        help="Mode to run: standard pipeline or experiment mode",
    )
    args = parser.parse_args()

    logger.info(
        f"Running analysis with configuration file: {args.config}, mode: {args.mode}"
    )
